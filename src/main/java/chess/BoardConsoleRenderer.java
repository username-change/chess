...
public class BoardConsoleRenderer {
		...
		for (int rank = 8; rank >= 1; rank--) {
			...
			for (File file : File.values()) {
				...
				if (board.isSquareEmpty(coordinates)) {
					line += getSpriteForEmpthySquare(coordinates);
				} else {
	...
	private String colorizeSprite(String spite, Color pieceColor, boolean isSquareDark) {
		String result = spite;
	...
	private String getSpriteForEmpthySquare(Coordinates coordinates) {
